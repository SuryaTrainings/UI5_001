sap.ui.define([
    ...
    return oController.extend("root.controller.main", {
        ...
        onInit: function () {
            ...
            var oRModel = oJsonModel.createResourseModel();
            var xmlModel = oJsonModel.createXMLModel('./models/studentData.xml');
            ...
            this.oCore.setModel(oRModel,"i18n");//i18n Resource model
            this.oCore.setModel(xmlModel); //" XML Model"

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ibmsdsalesproductsodatawithui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ibmsdsalesproductsodatawithui5-display": {
								"semanticObject": "ibmsdsalesproductsodatawithui5",
								"action": "display",
								"description": "A Fiori application for List of Products",
								"title": "List of products ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ibm.sd.sales.products.odatawithui5",
									"url": sap.ui.require.toUrl("ibm/sd/sales/products/odatawithui5")
								}
							}
						}
					}
